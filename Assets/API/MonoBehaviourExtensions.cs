...
public static class MonoBehaviourExtension  {
    ...
    public static Coroutine Tween (this MonoBehaviour self, float start, float end, float duration,Action<float> action , Easing.Type easingType, Action complete = null) {
        return self.StartCoroutine (_Tween (start, end, duration, action , complete, easingType));
    }
